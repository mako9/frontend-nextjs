...
export default function createCommunityPage() {
    ...
    const [canBeJoined, setCanBeJoined] = useState(null);
  
    const createCommunityWithLoading = clientSideRequest(createCommunity, state, setState);
    ...
    return (
      <div>
        ...
        <article>
          <h1 className={utilStyles.headingXl}>{t('myArea.createCommunity')}</h1>
        </article>
        <br/>
        <h3>{t('name')}</h3>
        ...
        <Input input={radius} setInput={setRadius} placeholder={t('community.radius')} className={'input_left'}/>
        <br/><br/>
        <div className="horizontal_container">
