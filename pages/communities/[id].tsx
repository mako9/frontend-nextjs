import {
    getCommunity,
    getMemberOfCommunity,
    getReguestingMemberOfCommunity,
...
export default function Community({
    ...
    return isOwned === 'true'
        ? ownedCommunity(session, communityData, members, requestingMember, t)
        : foreignCommunity(session, communityData, t)
}
