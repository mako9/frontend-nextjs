...
export async function createCommunity(
    ...
    const url = `${process.env.BACKEND_BASE_URL}/user/community`
    const result = await request<Community>(
        url,
        session,
        HttpMethod.Post,
        community
...
export async function getItemsOfCommunity(
    uuid,
    session?
...
export async function getMemberOfCommunity(
    uuid,
    session?
...
export async function getReguestingMemberOfCommunity(
    uuid,
    session?
): Promise<Page<User> | null> {
...
export async function approveMemberRequests(
    uuid,
    userUuids,
    session?
): Promise<Page<User> | null> {
...
export async function declineMemberRequests(
    uuid,
    userUuids,
    session?
): Promise<Page<User> | null> {
