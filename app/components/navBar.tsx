...
const NavBar = () => {
    ...
    const [isLoggedIn, setIsLoggedIn] = useState(
        data !== null && data?.status === 'authenticated'
    )
    ...
    if (isLoggedIn)
        menuList.push({ text: t('navBar.myArea'), href: '/my-area' })
        ...
        <header className={styles.nav_header}>
            <nav className={styles.nav}>
                <div className={styles.nav_list}>
                    <Link
                        className={`${
                            navActive ? styles.nav_element_hide : ''
                        }`}
                        href={'/'}
                    >
                        <img
                ...
                <div className={styles.nav_list}>
                    <div
                        className={`${styles.nav_menu_list} ${
                            navActive ? styles.nav_menu_list_show : ''
                        }`}
                    >
                        {menuList.map((menu, idx) => (
                            ...
                            >
                                <NavItem
                                    active={state?.selectedNavbarIndex === idx}
                                    {...menu}
                                />
                            </div>
                        ))}
